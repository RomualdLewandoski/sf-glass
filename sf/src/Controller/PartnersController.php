...
class PartnersController extends AbstractController
{
    ...
    {
        return $this->render('admin/pages/partners/listPartners.html.twig', [
    ...
    public function new(Request $request, ImageRepository $imageRepository): Response
    {
        ...
        return $this->render('admin/pages/partners/newPartner.html.twig', [
            'partner' => $partner,
    ...
    {
        return $this->render('admin/pages/partners/showPartner.html.twig', [
            'partner' => $partner,
        ]);
    }
     ...
     */
    public function edit(Request $request, Partners $partner, ImageRepository $imageRepository): Response
    {
        $form = $this->createForm(PartnersType::class, $partner);
        $form->handleRequest($request);
        ...
        return $this->render('admin/pages/partners/editPartners.html.twig', [
            'partner' => $partner,
            'images' => $imageRepository->findAll(),
            'form' => $form->createView(),
        ]);
